...
function selectedFilter(current: string, selected: string) {
  return current === selected
    ? "px-3 py-1 rounded-lg hover:underline dark:bg-sky-700 dark:text-gray-100"
    : "px-3 py-1 rounded-lg hover:underline dark:bg-sky-400 dark:text-gray-900";
}
                ...
                <li>
                  <Link
                    ...
                    className={`${
                      ...
                      "text-sky-400"
                    }  hover:underline hover:text-sky-400 transition-colors duration-200`}
                  >
